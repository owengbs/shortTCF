...
class PredictionResult(object):
	...
	def analyzable(self):
		...
		"""
		if None in [self.decvals, self.predicted_y, self.true_y,  self.model_id]:
			return False
...
# 			for y in true_y]
	...
	return PredictionResult(text_src, text_model._hashcode, true_y, predicted_y, dec_vals, svm_file, None, extra_svm_files)
